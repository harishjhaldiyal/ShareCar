...
$message .= "http://harishjhaldiyal.thecompletewebhosting.com/car-share/resetpassword.php?user_id=$user_id&key=$key";
if(mail($email, 'Reset your password', $message, 'From:'.'Admin@harishjhaldiyal.com')){
